...
public class DisplayAccountRegistrationControlsActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_account_registration_controls);
	...
	{	
		...
		EditText initialBalance = (EditText) findViewById(R.id.initialBalance);
		String initial_balance = initialBalance.getText().toString();
		...
		{
			NewAccount account = new NewAccount(initial_balance);
		...
		{
			Intent intent = new Intent(this, DisplayAccountRegistrationControlsActivity.class);
			startActivity(intent);
			 TextView textView = new TextView(this);
			 textView.setTextSize(20);
