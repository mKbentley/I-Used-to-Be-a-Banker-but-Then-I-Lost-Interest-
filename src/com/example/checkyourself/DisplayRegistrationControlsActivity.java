...
public class DisplayRegistrationControlsActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_display_registration_controls);
	...
	{	
		...
		{
			Intent intent = new Intent(this, DisplayRegistrationControlsActivity.class);
			startActivity(intent);
